	...
	switch (message)
	{
		...
		case WM_COMMAND:
			...
			case IDC_CONTACTME:
				...
				ShellExecute( GetMyWindowHandle( ), "open", "http://www.jonathangrimes.com/index.php?page=contact", 0, 0, SW_SHOWNORMAL );				
			...
			case IDC_VISITME:
				bClick = true;
				ShellExecute( GetMyWindowHandle( ), "open", "http://www.jonathangrimes.com/index.php", 0, 0, SW_SHOWNORMAL );
			...
			case IDC_PRODUCTHOME:
				bClick = true;
				ShellExecute( GetMyWindowHandle( ), "open", "http://www.jonathangrimes.com/index.php?page=projects&section=101", 0, 0, SW_SHOWNORMAL );
